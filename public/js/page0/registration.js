...
export default class Registration extends React.Component {
	render() {
        ...
        <Image class="tree0-1" path ="img/page0/tree1.svg"/>
        <Image class="tree0-2" path="img/page0/tree2.svg"/>
        <Image class="tree0-3" path="img/page0/tree1.svg"/>
        <Image class="tree0-4" path="img/page0/tree3.svg"/>
